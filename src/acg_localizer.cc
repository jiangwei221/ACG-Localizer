...
int main (int argc, char **argv)
{
  ...
  for( uint32_t i=0; i<nb_keyfiles; ++i, N+=1.0 )
  {
    ...
    ofs_details << " " << Rot.mp_data[0] << " " << Rot.mp_data[1] << " " << Rot.mp_data[2] << " " << Rot.mp_data[3] << " " << Rot.mp_data[4] << " " << Rot.mp_data[5] << " " << Rot.mp_data[6] << " " << Rot.mp_data[7] << " " << Rot.mp_data[8] << " " << proj_matrix.m_center << std::endl;
