...
//         std::cout << " "  << corr_3D_to_2D.size() << std::endl;
    ...
    if ( K.mp_data[0] > 0 )
      ofs << jpg_filename << " " << Rot.mp_data[0] << " " << Rot.mp_data[1] << " " << Rot.mp_data[2] << " " << Rot.mp_data[3] << " " << Rot.mp_data[4] << " " << Rot.mp_data[5] << " " << Rot.mp_data[6] << " " << Rot.mp_data[7] << " " << Rot.mp_data[8] << " " << proj_matrix.m_center << std::endl;
    else
      ofs << jpg_filename << " " << Rot.mp_data[0] << " " << -Rot.mp_data[1] << " " << -Rot.mp_data[2] << " " << Rot.mp_data[3] << " " << -Rot.mp_data[4] << " " << -Rot.mp_data[5] << " " << Rot.mp_data[6] << " " << -Rot.mp_data[7] << " " << -Rot.mp_data[8] << " " << proj_matrix.m_center << std::endl;
